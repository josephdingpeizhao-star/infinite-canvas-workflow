...
class LauncherController:
    ...
    def _workbench_pid(self, spawned: Sequence[tuple[ServiceSpec, int]]) -> int | None:
    ...
    def _wait_connection_ready(
        ...
        *,
        ...
        spawned: Sequence[tuple[ServiceSpec, int]],
    ) -> str:
    ...
    def _cleanup_spawned(self, spawned: Sequence[tuple[ServiceSpec, int]]) -> None:
    ...
    def _fail(self, message: str, spawned: Sequence[tuple[ServiceSpec, int]]) -> LaunchResult:
    ...
    def run(self) -> LaunchResult:
        ...
        spawned: list[tuple[ServiceSpec, int]] = []
        try:
